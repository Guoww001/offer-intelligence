...
assert(indexHtml.includes("oi-modern.css?v=20260828-vue-m4-revenue-flow"), "index.html 未更新 M4 modern CSS cache busting");
assert(auth.includes('oi-modern.js?v=20260828-vue-m4-revenue-flow'), "auth.js 未更新 M4 modern JS cache busting");
