...
assert(indexHtml.includes("oi-modern.css?v=20260828-vue-m4-publishers-brand-media"), "index.html 未更新 M4 modern CSS cache busting");
assert(auth.includes('oi-modern.js?v=20260828-vue-m4-publishers-brand-media'), "auth.js 未更新 M4 modern JS cache busting");
