(function () {
  ...
  const COPY = {
    zh: {
      ...
      memoryRecommendationExportTitle: "本次推荐 Excel",
      memoryRecommendationExportDescription: "只包含本次推荐商户（{matchedCount} 个），并保留原报告的工作表、字段和列顺序。",
      memoryRecommendationExportPartial: "请求 {requestedCount} 个，当前找到 {matchedCount} 个。",
      memoryRecommendationExportNoMatch: "当前没有找到符合条件的商户。",
      memoryRecommendationExportAmbiguous: "记忆栏中有多份报告，请在问题中明确 Tier。",
      memoryRecommendationExportUnavailable: "当前记忆报告无法生成结构化推荐导出。",
    ...
    en: {
      ...
      memoryRecommendationExportTitle: "Recommendation Excel",
      memoryRecommendationExportDescription: "Contains only the merchants in this recommendation ({matchedCount}) and preserves the original report sheets, fields, and column order.",
      memoryRecommendationExportPartial: "Requested {requestedCount}; currently found {matchedCount}.",
      memoryRecommendationExportNoMatch: "No merchants matched the current recommendation criteria.",
      memoryRecommendationExportAmbiguous: "Multiple reports are in memory; specify a Tier in the request.",
      memoryRecommendationExportUnavailable: "The current memory report cannot produce a structured recommendation export.",
      merchantId: "Merchant ID",
