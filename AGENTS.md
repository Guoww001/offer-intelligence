...
See `docs/chatbot-feature-report.md` for the full architecture — LLM intent classifier (DeepSeek/Codex via `llm_classify.py` + `skills/`), 7-intent routing in `answerPrompt()`, analysis engine, i18n, and all 34 involved files.
